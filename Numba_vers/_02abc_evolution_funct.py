...
@jit('float64[:](int32, float64[:], float64, float64,  float64[:])', nopython=True, cache=False)
...
## Case with vaccination continuous physical distance
@jit('types.Tuple((float64[:], float64[:,:]))(int32, float64[:],  float64[:,:], float64, float64,  int32, float64[:])',nopython=True, cache=True)
...
@jit('float64[:](float64, float64[:], int32, float64,   float64[:])',nopython=True,cache=True)
...
@jit('types.Tuple((float64[:], float64[:,:], float64[:,:]))(int32, float64[:], float64[:,:], float64[:,:], int32,  float64, int32, float64[:])',nopython=True,cache=True)
